...
var className = 'TypeAdjusterPartyReferenceType';

var TypeAdjusterPartyReferenceType = function(json, parentObj) {
  parentObj = parentObj || this;
    ...
    Custom: {
      type: "TypeCustomAdjusterPartyReferenceType",
      wsdlDefinition: {
        minOccurs: "0",
        name: "WL5G3N2:Custom",
        type: "corecomcust:CustomAdjusterPartyReferenceType",
        attribute: false,
        ns: "WL5G3N2"
      },
      mask: Modeler.GET | Modeler.SET,
...
module.exports = TypeAdjusterPartyReferenceType;
Modeler.register(TypeAdjusterPartyReferenceType, "TypeAdjusterPartyReferenceType");
