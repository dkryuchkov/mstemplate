...
var className = 'TypeDocumentLineReferenceType';

var TypeDocumentLineReferenceType = function(json, parentObj) {
  parentObj = parentObj || this;
    ...
    Custom: {
      type: "TypeCustomDocumentLineReferenceType",
      wsdlDefinition: {
        minOccurs: "0",
        name: "WL5G3N2:Custom",
        type: "corecomcust:CustomDocumentLineReferenceType",
        attribute: false,
        ns: "WL5G3N2"
      },
      mask: Modeler.GET | Modeler.SET,
...
module.exports = TypeDocumentLineReferenceType;
Modeler.register(TypeDocumentLineReferenceType, "TypeDocumentLineReferenceType");
