...
var className = 'TypeSenderTradingPartnerType';

var TypeSenderTradingPartnerType = function(json, parentObj) {
  parentObj = parentObj || this;
    ...
    Custom: {
      type: "TypeCustomSenderTradingPartnerType",
      wsdlDefinition: {
        minOccurs: "0",
        name: "WL5G3N2:Custom",
        type: "corecomcust:CustomSenderTradingPartnerType",
        attribute: false,
        ns: "WL5G3N2"
      },
...
module.exports = TypeSenderTradingPartnerType;
Modeler.register(TypeSenderTradingPartnerType, "TypeSenderTradingPartnerType");
