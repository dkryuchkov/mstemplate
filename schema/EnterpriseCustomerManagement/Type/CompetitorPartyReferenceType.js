...
var className = 'TypeCompetitorPartyReferenceType';

var TypeCompetitorPartyReferenceType = function(json, parentObj) {
  parentObj = parentObj || this;
    ...
    Custom: {
      type: "TypeCustomCompetitorPartyReferenceType",
      wsdlDefinition: {
        minOccurs: "0",
        name: "WL5G3N2:Custom",
        type: "corecomcust:CustomCompetitorPartyReferenceType",
        attribute: false,
        ns: "WL5G3N2"
      },
      mask: Modeler.GET | Modeler.SET,
...
module.exports = TypeCompetitorPartyReferenceType;
Modeler.register(TypeCompetitorPartyReferenceType, "TypeCompetitorPartyReferenceType");
