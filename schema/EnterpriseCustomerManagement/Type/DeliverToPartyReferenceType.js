...
var className = 'TypeDeliverToPartyReferenceType';

var TypeDeliverToPartyReferenceType = function(json, parentObj) {
  parentObj = parentObj || this;
    ...
    Custom: {
      type: "TypeCustomDeliverToPartyReferenceType",
      wsdlDefinition: {
        minOccurs: "0",
        name: "WL5G3N2:Custom",
        type: "corecomcust:CustomDeliverToPartyReferenceType",
        attribute: false,
        ns: "WL5G3N2"
      },
      mask: Modeler.GET | Modeler.SET,
...
module.exports = TypeDeliverToPartyReferenceType;
Modeler.register(TypeDeliverToPartyReferenceType, "TypeDeliverToPartyReferenceType");
