...
var className = 'TypeEmployerPartyReferenceType';

var TypeEmployerPartyReferenceType = function(json, parentObj) {
  parentObj = parentObj || this;
    ...
    Custom: {
      type: "TypeCustomEmployerPartyReferenceType",
      wsdlDefinition: {
        minOccurs: "0",
        name: "WL5G3N2:Custom",
        type: "corecomcust:CustomEmployerPartyReferenceType",
        attribute: false,
        ns: "WL5G3N2"
      },
      mask: Modeler.GET | Modeler.SET,
...
module.exports = TypeEmployerPartyReferenceType;
Modeler.register(TypeEmployerPartyReferenceType, "TypeEmployerPartyReferenceType");
