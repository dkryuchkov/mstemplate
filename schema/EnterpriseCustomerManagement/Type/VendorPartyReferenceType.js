...
var className = 'TypeVendorPartyReferenceType';

var TypeVendorPartyReferenceType = function(json, parentObj) {
  parentObj = parentObj || this;
    ...
    Custom: {
      type: "TypeCustomVendorPartyReferenceType",
      wsdlDefinition: {
        minOccurs: "0",
        name: "WL5G3N2:Custom",
        type: "corecomcust:CustomVendorPartyReferenceType",
        attribute: false,
        ns: "WL5G3N2"
      },
      mask: Modeler.GET | Modeler.SET,
...
module.exports = TypeVendorPartyReferenceType;
Modeler.register(TypeVendorPartyReferenceType, "TypeVendorPartyReferenceType");
