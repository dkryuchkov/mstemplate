...
Modeler.extend = function(type, definition, obj, json) {
  ...
  obj.validate = function() {
    for (var p in definition) {
      var prop = definition[p];
      if (prop.required && (this[p] == null)) return `${prop} is required`;
      if (modelCache[prop.type] && (this[prop.type] instanceof Object) && this[prop.type].hasOwnProperty('validate') && this[prop.type].validate()) return this[prop.type].validate();
    }
    return null;
  };
  obj.validator = () => true;
  Object.defineProperty(obj, "validate", { enumerable: false });
  Object.defineProperty(obj, "validator", { enumerable: false });
