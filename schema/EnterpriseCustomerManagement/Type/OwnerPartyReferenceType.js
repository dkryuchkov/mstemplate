...
var className = 'TypeOwnerPartyReferenceType';

var TypeOwnerPartyReferenceType = function(json, parentObj) {
  parentObj = parentObj || this;
    ...
    Custom: {
      type: "TypeCustomOwnerPartyReferenceType",
      wsdlDefinition: {
        minOccurs: "0",
        name: "WL5G3N2:Custom",
        type: "corecomcust:CustomOwnerPartyReferenceType",
        attribute: false,
        ns: "WL5G3N2"
      },
      mask: Modeler.GET | Modeler.SET,
...
module.exports = TypeOwnerPartyReferenceType;
Modeler.register(TypeOwnerPartyReferenceType, "TypeOwnerPartyReferenceType");
