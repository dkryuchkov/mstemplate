...
var className = 'TypeCarrierPartyReferenceType';

var TypeCarrierPartyReferenceType = function(json, parentObj) {
  parentObj = parentObj || this;
    ...
    Custom: {
      type: "TypeCustomCarrierPartyReferenceType",
      wsdlDefinition: {
        minOccurs: "0",
        name: "WL5G3N2:Custom",
        type: "corecomcust:CustomCarrierPartyReferenceType",
        attribute: false,
        ns: "WL5G3N2"
      },
      mask: Modeler.GET | Modeler.SET,
...
module.exports = TypeCarrierPartyReferenceType;
Modeler.register(TypeCarrierPartyReferenceType, "TypeCarrierPartyReferenceType");
