...
var className = 'TypeB2BMHeaderType';

var TypeB2BMHeaderType = function(json, parentObj) {
  parentObj = parentObj || this;
    ...
    B2BDocumentType: {
      ...
      wsdlDefinition: {
        ...
        "xsd:annotation": {
          "xsd:documentation": "Information about the B2B document type, standard and version being exchanged between the trading partners using the B2B software"
        },
        attribute: false,
        ns: "WL5G3N2"
      },
    ...
    Custom: {
      type: "TypeCustomB2BMHeaderType",
      wsdlDefinition: {
        minOccurs: "0",
        name: "WL5G3N2:Custom",
        type: "corecomcust:CustomB2BMHeaderType",
        attribute: false,
        ns: "WL5G3N2"
      },
      mask: Modeler.GET | Modeler.SET,
...
module.exports = TypeB2BMHeaderType;
Modeler.register(TypeB2BMHeaderType, "TypeB2BMHeaderType");
