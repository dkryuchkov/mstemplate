...
var className = 'TypeReceivingPartyReferenceType';

var TypeReceivingPartyReferenceType = function(json, parentObj) {
  parentObj = parentObj || this;
    ...
    Custom: {
      type: "TypeCustomReceivingPartyReferenceType",
      wsdlDefinition: {
        minOccurs: "0",
        name: "WL5G3N2:Custom",
        type: "corecomcust:CustomReceivingPartyReferenceType",
        attribute: false,
        ns: "WL5G3N2"
      },
      mask: Modeler.GET | Modeler.SET,
...
module.exports = TypeReceivingPartyReferenceType;
Modeler.register(TypeReceivingPartyReferenceType, "TypeReceivingPartyReferenceType");
