...
var className = 'TypeRemitToPartyReferenceType';

var TypeRemitToPartyReferenceType = function(json, parentObj) {
  parentObj = parentObj || this;
    ...
    Custom: {
      type: "TypeCustomRemitToPartyReferenceType",
      wsdlDefinition: {
        minOccurs: "0",
        name: "WL5G3N2:Custom",
        type: "corecomcust:CustomRemitToPartyReferenceType",
        attribute: false,
        ns: "WL5G3N2"
      },
      mask: Modeler.GET | Modeler.SET,
...
module.exports = TypeRemitToPartyReferenceType;
Modeler.register(TypeRemitToPartyReferenceType, "TypeRemitToPartyReferenceType");
