...
var className = 'TypeTimePeriodType';

var TypeTimePeriodType = function(json, parentObj) {
...
module.exports = TypeTimePeriodType;
Modeler.register(TypeTimePeriodType, "TypeTimePeriodType");
