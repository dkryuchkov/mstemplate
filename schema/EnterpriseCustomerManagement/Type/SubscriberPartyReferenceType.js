...
var className = 'TypeSubscriberPartyReferenceType';

var TypeSubscriberPartyReferenceType = function(json, parentObj) {
  parentObj = parentObj || this;
    ...
    Custom: {
      type: "TypeCustomSubscriberPartyReferenceType",
      wsdlDefinition: {
        minOccurs: "0",
        name: "WL5G3N2:Custom",
        type: "corecomcust:CustomSubscriberPartyReferenceType",
        attribute: false,
        ns: "WL5G3N2"
      },
      mask: Modeler.GET | Modeler.SET,
...
module.exports = TypeSubscriberPartyReferenceType;
Modeler.register(TypeSubscriberPartyReferenceType, "TypeSubscriberPartyReferenceType");
