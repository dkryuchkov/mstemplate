...
var className = 'TypeRMASalesOrderScheduleReferenceType';

var TypeRMASalesOrderScheduleReferenceType = function(json, parentObj) {
  parentObj = parentObj || this;
    ...
    undefined: {
      type: "string",
      wsdlDefinition: {
        base: "SalesOrderScheduleReferenceType",
        attribute: false,
        type: "xsd:string"
      },
      mask: Modeler.GET | Modeler.SET,
...
module.exports = TypeRMASalesOrderScheduleReferenceType;
Modeler.register(TypeRMASalesOrderScheduleReferenceType, "TypeRMASalesOrderScheduleReferenceType");
