...
var className = 'TypeShipFromPartyReferenceType';

var TypeShipFromPartyReferenceType = function(json, parentObj) {
  parentObj = parentObj || this;
    ...
    Custom: {
      type: "TypeCustomShipFromPartyReferenceType",
      wsdlDefinition: {
        minOccurs: "0",
        name: "WL5G3N2:Custom",
        type: "corecomcust:CustomShipFromPartyReferenceType",
        attribute: false,
        ns: "WL5G3N2"
      },
      mask: Modeler.GET | Modeler.SET,
...
module.exports = TypeShipFromPartyReferenceType;
Modeler.register(TypeShipFromPartyReferenceType, "TypeShipFromPartyReferenceType");
