        ...
        (function createFunction(functionName, properties) {
          parent[properties.input.replace("Element", "")] = function (json) {
            ...
            this.preview = function () {
              return '<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/"  xmlns:xacml-context="urn:oasis:names:tc:xacml:2.0:context:schema:cd:04" xmlns:wsa="http://schemas.xmlsoap.org/ws/2003/03/addressing" xmlns:WL5G3N2="http://xmlns.oracle.com/EnterpriseObjects/Core/Common/V2" xmlns:corecomcust="http://xmlns.oracle.com/EnterpriseObjects/Core/Custom/Common/V2" xmlns:WL5G3N1="http://xmlns.oracle.com/EnterpriseObjects/Core/EBO/CustomerParty/V2" xmlns:corecustomerpartycust="http://xmlns.oracle.com/EnterpriseObjects/Core/Custom/EBO/CustomerParty/V2">' +
                '<soap:Body>' +
