...
var className = 'TypeRequiredByPartyReferenceType';

var TypeRequiredByPartyReferenceType = function(json, parentObj) {
  parentObj = parentObj || this;
    ...
    Custom: {
      type: "TypeCustomRequiredByPartyReferenceType",
      wsdlDefinition: {
        minOccurs: "0",
        name: "WL5G3N2:Custom",
        type: "corecomcust:CustomRequiredByPartyReferenceType",
        attribute: false,
        ns: "WL5G3N2"
      },
      mask: Modeler.GET | Modeler.SET,
...
module.exports = TypeRequiredByPartyReferenceType;
Modeler.register(TypeRequiredByPartyReferenceType, "TypeRequiredByPartyReferenceType");
