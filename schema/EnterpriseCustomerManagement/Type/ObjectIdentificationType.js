...
var className = 'TypeObjectIdentificationType';

var TypeObjectIdentificationType = function(json, parentObj) {
  parentObj = parentObj || this;
    ...
    TypeCode: {
      ...
      wsdlDefinition: {
        ...
        type: "CodeType",
        "xsd:annotation": {
          "xsd:documentation": "Indicate the type/concept the object identification refers to, e.g., PurchaseOrder, SalesOrder, PurchaseOrder, SalesOrder. This should generally be one of the EBO names or qualified EBO names such as RMASalesOrder."
        },
        attribute: false,
        ns: "WL5G3N2"
      },
...
module.exports = TypeObjectIdentificationType;
Modeler.register(TypeObjectIdentificationType, "TypeObjectIdentificationType");
