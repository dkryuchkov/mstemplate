...
var className = 'TypeShipToPartyReferenceType';

var TypeShipToPartyReferenceType = function(json, parentObj) {
  parentObj = parentObj || this;
    ...
    Custom: {
      type: "TypeCustomShipToPartyReferenceType",
      wsdlDefinition: {
        minOccurs: "0",
        name: "WL5G3N2:Custom",
        type: "corecomcust:CustomShipToPartyReferenceType",
        attribute: false,
        ns: "WL5G3N2"
      },
      mask: Modeler.GET | Modeler.SET,
...
module.exports = TypeShipToPartyReferenceType;
Modeler.register(TypeShipToPartyReferenceType, "TypeShipToPartyReferenceType");
