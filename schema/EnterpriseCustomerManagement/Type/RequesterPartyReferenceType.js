...
var className = 'TypeRequesterPartyReferenceType';

var TypeRequesterPartyReferenceType = function(json, parentObj) {
  parentObj = parentObj || this;
    ...
    Custom: {
      type: "TypeCustomRequesterPartyReferenceType",
      wsdlDefinition: {
        minOccurs: "0",
        name: "WL5G3N2:Custom",
        type: "corecomcust:CustomRequesterPartyReferenceType",
        attribute: false,
        ns: "WL5G3N2"
      },
      mask: Modeler.GET | Modeler.SET,
...
module.exports = TypeRequesterPartyReferenceType;
Modeler.register(TypeRequesterPartyReferenceType, "TypeRequesterPartyReferenceType");
