...
var className = 'TypePublisherPartyReferenceType';

var TypePublisherPartyReferenceType = function(json, parentObj) {
  parentObj = parentObj || this;
    ...
    Custom: {
      type: "TypeCustomPublisherPartyReferenceType",
      wsdlDefinition: {
        minOccurs: "0",
        name: "WL5G3N2:Custom",
        type: "corecomcust:CustomPublisherPartyReferenceType",
        attribute: false,
        ns: "WL5G3N2"
      },
      mask: Modeler.GET | Modeler.SET,
...
module.exports = TypePublisherPartyReferenceType;
Modeler.register(TypePublisherPartyReferenceType, "TypePublisherPartyReferenceType");
