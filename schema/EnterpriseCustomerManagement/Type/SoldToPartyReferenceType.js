...
var className = 'TypeSoldToPartyReferenceType';

var TypeSoldToPartyReferenceType = function(json, parentObj) {
  parentObj = parentObj || this;
    ...
    Custom: {
      type: "TypeCustomSoldToPartyReferenceType",
      wsdlDefinition: {
        minOccurs: "0",
        name: "WL5G3N2:Custom",
        type: "corecomcust:CustomSoldToPartyReferenceType",
        attribute: false,
        ns: "WL5G3N2"
      },
      mask: Modeler.GET | Modeler.SET,
...
module.exports = TypeSoldToPartyReferenceType;
Modeler.register(TypeSoldToPartyReferenceType, "TypeSoldToPartyReferenceType");
