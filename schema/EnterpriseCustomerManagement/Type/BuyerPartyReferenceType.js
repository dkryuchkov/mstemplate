...
var className = 'TypeBuyerPartyReferenceType';

var TypeBuyerPartyReferenceType = function(json, parentObj) {
  parentObj = parentObj || this;
    ...
    Custom: {
      type: "TypeCustomBuyerPartyReferenceType",
      wsdlDefinition: {
        minOccurs: "0",
        name: "WL5G3N2:Custom",
        type: "corecomcust:CustomBuyerPartyReferenceType",
        attribute: false,
        ns: "WL5G3N2"
      },
      mask: Modeler.GET | Modeler.SET,
...
module.exports = TypeBuyerPartyReferenceType;
Modeler.register(TypeBuyerPartyReferenceType, "TypeBuyerPartyReferenceType");
