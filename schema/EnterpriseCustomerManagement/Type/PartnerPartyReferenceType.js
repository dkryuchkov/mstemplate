...
var className = 'TypePartnerPartyReferenceType';

var TypePartnerPartyReferenceType = function(json, parentObj) {
  parentObj = parentObj || this;
    ...
    Custom: {
      type: "TypeCustomPayeePartyReferenceType",
      wsdlDefinition: {
        minOccurs: "0",
        name: "WL5G3N2:Custom",
        type: "corecomcust:CustomPayeePartyReferenceType",
        attribute: false,
        ns: "WL5G3N2"
      },
      mask: Modeler.GET | Modeler.SET,
...
module.exports = TypePartnerPartyReferenceType;
Modeler.register(TypePartnerPartyReferenceType, "TypePartnerPartyReferenceType");
