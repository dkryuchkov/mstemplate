...
var className = 'TypeBillFromPartyReferenceType';

var TypeBillFromPartyReferenceType = function(json, parentObj) {
  parentObj = parentObj || this;
    ...
    Custom: {
      type: "TypeCustomBillFromPartyReferenceType",
      wsdlDefinition: {
        minOccurs: "0",
        name: "WL5G3N2:Custom",
        type: "corecomcust:CustomBillFromPartyReferenceType",
        attribute: false,
        ns: "WL5G3N2"
      },
      mask: Modeler.GET | Modeler.SET,
...
module.exports = TypeBillFromPartyReferenceType;
Modeler.register(TypeBillFromPartyReferenceType, "TypeBillFromPartyReferenceType");
