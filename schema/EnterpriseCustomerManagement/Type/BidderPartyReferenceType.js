...
var className = 'TypeBidderPartyReferenceType';

var TypeBidderPartyReferenceType = function(json, parentObj) {
  parentObj = parentObj || this;
    ...
    Custom: {
      type: "TypeCustomBidderPartyReferenceType",
      wsdlDefinition: {
        minOccurs: "0",
        name: "WL5G3N2:Custom",
        type: "corecomcust:CustomBidderPartyReferenceType",
        attribute: false,
        ns: "WL5G3N2"
      },
      mask: Modeler.GET | Modeler.SET,
...
module.exports = TypeBidderPartyReferenceType;
Modeler.register(TypeBidderPartyReferenceType, "TypeBidderPartyReferenceType");
